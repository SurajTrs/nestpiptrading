...
const ApiTradingBanner: React.FC = () => {
        ...
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            <h1 className="fw-bold mb-3" style={{ fontSize: '2.5rem' }}>
              Build and Automate with API Trading
            </h1>
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Connect your strategies, trading systems, and data analytics directly to our trading engine.
            </p>
            <ul
            ...
            >
              <li>REST & FIX APIs for advanced integration</li>
              <li>Real-time market data & order execution</li>
              <li>Scalable infrastructure for high-frequency trading</li>
            </ul>

            <div className="d-flex flex-wrap gap-3 justify-content-center justify-content-md-start mt-4">
              <a
                href="/tools/api-trading"
          ...
          <div className="col-md-6 mt-4 mt-md-0 text-center">
            <img
              src="/assets/api-trading-banner.png"
              alt="API Trading Interface"
...
export default ApiTradingBanner;
