...
const CurrencyConverterBanner: React.FC = () => {
  ...
  return (
    <section style={{ backgroundColor: '#f24521', color: '#fff', padding: '5rem 0' }}>
      <div className="container text-center">
        ...
        {/* Currency Converter Hero Content */}
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            ...
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Instantly convert currencies using live forex rates. Stay updated with global exchange values anytime.
            </p>
            <ul
            ...
            >
              <li>Live exchange rate data</li>
              <li>Supports all major and minor currency pairs</li>
              <li>Simple and fast conversions</li>
            </ul>
          ...
          <div className="col-md-6 mt-4 mt-md-0 text-center">
            <img
              src="/assets/currency-converter-banner.png"
...
export default CurrencyConverterBanner;
