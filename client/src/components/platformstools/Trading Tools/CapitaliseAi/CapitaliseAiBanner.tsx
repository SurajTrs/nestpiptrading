  ...
  return (
    <section style={{ backgroundColor: '#f24521', color: '#fff', padding: '5rem 0' }}>
      <div className="container text-center">
        ...
        {/* Capitalise.ai Content */}
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            <h1 className="fw-bold mb-3" style={{ fontSize: '2.5rem' }}>
              Automate Your Trading with Capitalise.ai
            </h1>
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Write your trading strategies in plain English and let Capitalise.ai execute them automatically.
            </p>
            <ul
            ...
            >
              <li>No coding required – write strategies in natural language</li>
              <li>Automated backtesting, alerts & trade execution</li>
              <li>Boost your trading speed and precision</li>
            </ul>

            <div className="d-flex flex-wrap gap-3 justify-content-center justify-content-md-start mt-4">
              <a
                href="/tools/capitaliseai"
          ...
          <div className="col-md-6 mt-4 mt-md-0 text-center">
            <img
              src="/assets/capitalise-ai-banner.png"
              alt="Capitalise.ai Trading Automation"
