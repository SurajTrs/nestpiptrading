        ...
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            ...
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Enhance your strategies with AI-driven insights, automation, and predictive analytics designed for traders.
            </p>
            <ul
            ...
            >
              <li>Analyze market data using machine learning</li>
              <li>Automate trading decisions with smart signals</li>
              <li>Leverage sentiment, pattern, and risk analysis</li>
            </ul>
          ...
          <div className="col-md-6 mt-4 mt-md-0 text-center">
            <img
              src="/assets/ai-tools-banner.png"
              alt="AI Trading Tools"
