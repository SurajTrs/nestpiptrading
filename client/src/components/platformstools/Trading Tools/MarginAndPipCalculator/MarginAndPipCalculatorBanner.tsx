...
const MarginAndPipCalculatorBanner: React.FC = () => {
  ...
  return (
    <section style={{ backgroundColor: '#f24521', color: '#fff', padding: '5rem 0' }}>
      <div className="container text-center">
        ...
        {/* Margin and Pip Calculator Content */}
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            ...
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Calculate your trading margins, pip values, and position sizes with accuracy using our smart calculator.
            </p>
            <ul
            ...
            >
              <li>Calculate required margin before placing a trade</li>
              <li>Find pip values for any currency pair</li>
              <li>Plan your trades with precision and control</li>
            </ul>

            <div className="d-flex flex-wrap gap-3 justify-content-center justify-content-md-start mt-4">
              <a
                href="/platforms-tools/margin-pip-calculator"
          ...
          <div className="col-md-6 mt-4 mt-md-0 text-center">
            <img
              src="/assets/margin-pip-calculator-banner.png"
              alt="Margin and Pip Calculator"
...
export default MarginAndPipCalculatorBanner;
