...
const marketNavItems = [
  ...
  { icon: '/icons/MarginCalculator-icon.svg', label: 'Margin and Pip Calculator' },
...
const PerformanceAnalyticsBanner: React.FC = () => {
        ...
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            ...
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Monitor your trading performance with precision. Gain insights into your wins, losses, and areas for improvement.
            </p>
            <ul
            ...
            >
              <li>Detailed reports on trade history & profitability</li>
              <li>Risk/reward analysis and drawdown tracking</li>
              <li>Improve your edge with custom metrics</li>
            </ul>

            <div className="d-flex flex-wrap gap-3 justify-content-center justify-content-md-start mt-4">
              <a
                href="/tools/performance-analytics"
          ...
          <div className="col-md-6 mt-4 mt-md-0 text-center">
            <img
              src="/assets/performance-analytics-banner.png"
              alt="Performance Analytics Tool"
...
export default PerformanceAnalyticsBanner;
