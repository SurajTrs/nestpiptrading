...
const TradingViewBanner: React.FC = () => {
  ...
  return (
    <section style={{ backgroundColor: '#f24521', color: '#fff', padding: '5rem 0' }}>
      <div className="container text-center">
        ...
        {/* TradingView Hero Content */}
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            <h1 className="fw-bold mb-3" style={{ fontSize: '2.5rem' }}>
              Unlock Powerful Market Insights with TradingView
            </h1>
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Access advanced charting tools, live market data, and an active trader community.
            </p>
            <ul
            ...
            >
              <li>Customizable charts & technical indicators</li>
              <li>Real-time data & alerts</li>
              <li>Social trading & idea sharing</li>
            </ul>
          ...
          <div className="col-md-6 mt-4 mt-md-0 text-center">
            <img
              src="/assets/tradingview-banner.png"
