  ...
  return (
    <section style={{ backgroundColor: '#f24521', color: '#fff', padding: '5rem 0' }}>
      <div className="container text-center">
        ...
        {/* WebTrader Hero Content */}
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            <h1 className="fw-bold mb-3" style={{ fontSize: '2.5rem' }}>
              Trade Directly from Your Browser with Web Trader
            </h1>
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              No downloads required. Enjoy fast execution, powerful tools, and full trading capabilities online.
            </p>
            <ul
            ...
            >
              <li>Accessible on any browser & device</li>
              <li>Real-time charts, news & indicators</li>
              <li>Lightning-fast execution and secure login</li>
            </ul>
          ...
          <div className="col-md-6 mt-4 mt-md-0 text-center">
            <img
              src="/assets/webtrader-banner.png"
