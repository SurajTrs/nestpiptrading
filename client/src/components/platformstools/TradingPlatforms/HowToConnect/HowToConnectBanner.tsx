...
const HowToConnectBanner: React.FC = () => {
  ...
  return (
    <section style={{ backgroundColor: '#f24521', color: '#fff', padding: '5rem 0' }}>
      <div className="container text-center">
        ...
        {/* How to Connect Hero Content */}
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            <h1 className="fw-bold mb-3" style={{ fontSize: '2.5rem' }}>
              Connect to Your Platform in Minutes
            </h1>
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Whether you are using desktop, mobile, or web, follow our simple guide to connect and start trading quickly.
            </p>
            <ul
            ...
            >
              <li>Step-by-step connection guides</li>
              <li>Login instructions for all devices</li>
              <li>Secure and reliable setup</li>
            </ul>

            <div className="d-flex flex-wrap gap-3 justify-content-center justify-content-md-start mt-4">
              <a
                href="/platforms/how-to-connect"
          ...
          <div className="col-md-6 mt-4 mt-md-0 text-center">
            <img
              src="/assets/how-to-connect-banner.png"
              alt="How to Connect to Trading Platforms"
...
export default HowToConnectBanner;
