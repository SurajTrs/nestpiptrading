...
const MetaTrader5Banner: React.FC = () => {
      ...
      <div className="container text-center">
        ...
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            ...
            >
              <li>Trade forex, stocks, commodities, and more</li>
              <li>Depth of market & advanced indicators</li>
              <li>Expert Advisors (EAs) and algorithmic trading</li>
            </ul>
          ...
          <div className="col-md-6 mt-4 mt-md-0 text-center">
            <img
              src="/assets/metatrader5-banner.png"
...
export default MetaTrader5Banner;
