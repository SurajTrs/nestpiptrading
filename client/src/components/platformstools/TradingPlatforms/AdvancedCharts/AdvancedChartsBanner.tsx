...
const AdvancedChartsBanner: React.FC = () => {
  ...
  return (
    <section style={{ backgroundColor: '#f24521', color: '#fff', padding: '5rem 0' }}>
      <div className="container text-center">
        ...
        {/* Advanced Charts Hero Content */}
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            <h1 className="fw-bold mb-3" style={{ fontSize: '2.5rem' }}>
              Visualize the Market with Precision
            </h1>
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Unlock professional-level charting tools with drawing features, custom layouts, and multi-timeframe support.
            </p>
            <ul
            ...
            >
              ...
              <li>Dozens of technical indicators & tools</li>
              <li>Custom layouts and strategy testing</li>
            </ul>

            <div className="d-flex flex-wrap gap-3 justify-content-center justify-content-md-start mt-4">
              <a
                href="/platforms/advanced-charts"
          ...
          <div className="col-md-6 mt-4 mt-md-0 text-center">
            <img
              src="/assets/advanced-charts-banner.png"
...
export default AdvancedChartsBanner;
