        ...
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            <h1 className="fw-bold mb-3" style={{ fontSize: '2.5rem' }}>
              Get Started Trading with Confidence
            </h1>
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Begin your trading journey with easy account setup, tutorials, and platform downloads.
            </p>
            <ul
            ...
            >
              <li>Simple account creation process</li>
              <li>Download desktop and mobile platforms</li>
            ...
            <div className="d-flex flex-wrap gap-3 justify-content-center justify-content-md-start mt-4">
              ...
              <a
                ...
                style={{ borderRadius: '12px', minWidth: '180px', color: '#fff' }}
              >
                Download Platforms
              </a>
            </div>
