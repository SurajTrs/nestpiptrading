...
const marketNavItems = [
  { icon: '/icons/GetStarted-icon.svg', label: 'Get Started' },
  { icon: '/icons/DownloadCentre-icon.svg', label: 'Download Centre' },
  { icon: '/icons/PlatformTutorials-icon.svg', label: 'Platform Tutorials' },
];

const PlatformTutorialsBanner: React.FC = () => {
        ...
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            <h1 className="fw-bold mb-3" style={{ fontSize: '2.5rem' }}>
              Learn to Trade with Our Platform Tutorials
            </h1>
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Step-by-step video guides and articles to help you master our trading platforms.
            </p>
            <ul
            ...
            >
              <li>Comprehensive tutorials for MetaTrader, WebTrader, and Mobile Apps</li>
              <li>Tips for advanced charting and order execution</li>
              <li>Learn at your own pace with easy-to-follow content</li>
            </ul>

            <div className="d-flex flex-wrap gap-3 justify-content-center justify-content-md-start mt-4">
              <a
                href="/resources/platform-tutorials"
          ...
          <div className="col-md-6 mt-4 mt-md-0 text-center">
            <img
              src="/assets/platform-tutorials-banner.png"
              alt="Platform Tutorials"
...
export default PlatformTutorialsBanner;
