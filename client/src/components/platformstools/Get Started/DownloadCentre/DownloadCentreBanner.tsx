...
const DownloadCentreBanner: React.FC = () => {
  ...
  return (
    <section style={{ backgroundColor: '#f24521', color: '#fff', padding: '5rem 0' }}>
      <div className="container text-center">
        ...
        {/* Download Centre Content */}
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            <h1 className="fw-bold mb-3" style={{ fontSize: '2.5rem' }}>
              Download the Latest Trading Platforms and Tools
            </h1>
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Access the newest versions of our desktop, mobile, and web trading platforms for a seamless experience.
            </p>
            <ul
            ...
            >
              <li>MetaTrader 4 and 5 for desktop and mobile</li>
              <li>WebTrader for browser-based trading</li>
              <li>TradingView charts and tools</li>
            </ul>
          ...
          <div className="col-md-6 mt-4 mt-md-0 text-center">
            <img
              src="/assets/download-centre-banner.png"
              alt="Download Centre"
...
export default DownloadCentreBanner;
