  ...
  return (
    <section style={{ backgroundColor: '#f24521', color: '#fff', padding: '5rem 0' }}>
      <div className="container text-center">
        ...
        {/* USD/JPY Hero Content */}
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            <h1 className="fw-bold mb-3" style={{ fontSize: '2.5rem' }}>
              Trade USD/JPY with Confidence
            </h1>
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Explore one of the most traded forex pairs — the US Dollar vs Japanese Yen — ideal for volatility-based strategies.
            </p>
            <ul
            ...
            >
              ...
              <li>Active during Asian and US sessions</li>
              <li>Technical trader favorite</li>
            </ul>
          ...
          <div className="col-md-6 mt-4 mt-md-0 text-center">
            <img
              ...
              alt="Trade USD/JPY illustration"
