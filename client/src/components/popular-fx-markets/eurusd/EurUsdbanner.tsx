        ...
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            <h1 className="fw-bold mb-3" style={{ fontSize: '2.5rem' }}>
              Trade EUR/USD with Confidence
            </h1>
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Access the world most popular forex pair with tight spreads and powerful trading tools.
            </p>
            <ul
            ...
            >
              ...
              <li>Fast execution with low latency</li>
              <li>No commissions on standard accounts</li>
            </ul>
          ...
          <div className="col-md-6 mt-4 mt-md-0 text-center">
            <img
              ...
              alt="Trade EUR/USD illustration"
