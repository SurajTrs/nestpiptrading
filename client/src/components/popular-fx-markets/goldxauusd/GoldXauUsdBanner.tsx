  ...
  return (
    <section style={{ backgroundColor: '#f24521', color: '#fff', padding: '5rem 0' }}>
      <div className="container text-center">
        ...
        {/* Gold (XAU/USD) Hero Content */}
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            <h1 className="fw-bold mb-3" style={{ fontSize: '2.5rem' }}>
              Trade Gold (XAU/USD) with Precision
            </h1>
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Capture opportunities in the world’s most traded precious metal — Gold against the US Dollar — known for volatility and hedging.
            </p>
            <ul
            ...
            >
              <li>Spreads from 0.3 pips</li>
              <li>24/5 gold trading access</li>
              <li>Perfect for inflation hedging strategies</li>
            </ul>
          ...
          <div className="col-md-6 mt-4 mt-md-0 text-center">
            <img
              src="/assets/gold-xauusd-banner.png"
              alt="Trade Gold illustration"
