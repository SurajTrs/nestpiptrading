...
const UsdChfChart: React.FC = () => {
  ...
  const spread = 0.00019; // Based on 1.9 pips
  ...
  useEffect(() => {
    ...
    socket.onopen = () => {
      socket.send(
        JSON.stringify({ action: "subscribe", params: { symbols: "USD/CHF" } })
      );
    };
      ...
      <div className="mx-auto max-w-screen-xl bg-white rounded-2xl shadow-lg border border-orange-200 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4">
          ...
          <div className="col-span-1 bg-orange-50 p-4 border-start border-orange-200">
            ...
            <p className="mb-1">
              LOW: <strong>{low !== null ? low.toFixed(5) : "0.79314"}</strong>
            </p>
            <p className="mb-1">
              HIGH: <strong>{high !== null ? high.toFixed(5) : "0.79924"}</strong>
            </p>
