  ...
  return (
    <section style={{ backgroundColor: '#f24521', color: '#fff', padding: '5rem 0' }}>
      <div className="container text-center">
        ...
        {/* USD/CHF Hero Content */}
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            <h1 className="fw-bold mb-3" style={{ fontSize: '2.5rem' }}>
              Trade USD/CHF with Confidence
            </h1>
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Navigate one of the key safe-haven pairs in forex — the US Dollar vs Swiss Franc — known for stability and precision.
            </p>
            <ul
            ...
            >
              <li>Consistently tight spreads</li>
              <li>Popular in risk-off markets</li>
              <li>Perfect for low-volatility strategies</li>
            </ul>
          ...
          <div className="col-md-6 mt-4 mt-md-0 text-center">
            <img
              src="/assets/usdchf-banner.png"
              alt="Trade USD/CHF illustration"
