...
const GbpUsdChartWithSidebar: React.FC = () => {
  ...
  const spread = 0.00017; // Based on 1.7 pips
  ...
  useEffect(() => {
    ...
    socket.onopen = () => {
      socket.send(
        JSON.stringify({ action: "subscribe", params: { symbols: "GBP/USD" } })
      );
    };
    ...
    socket.onmessage = (msg: MessageEvent) => {
      ...
      if (data.symbol === "GBP/USD" && data.price) {
...
export default GbpUsdChartWithSidebar;
