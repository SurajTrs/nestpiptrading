        ...
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            <h1 className="fw-bold mb-3" style={{ fontSize: '2.5rem' }}>
              Trade GBP/USD with Confidence
            </h1>
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Take advantage of market opportunities in the British Pound vs US Dollar pair — a key indicator of global sentiment.
            </p>
            <ul
            ...
            >
              <li>Spreads from 0.2 pips</li>
              <li>High liquidity during London/New York overlap</li>
              <li>Advanced charting and execution tools</li>
            </ul>
          ...
          <div className="col-md-6 mt-4 mt-md-0 text-center">
            <img
              ...
              alt="Trade GBP/USD illustration"
