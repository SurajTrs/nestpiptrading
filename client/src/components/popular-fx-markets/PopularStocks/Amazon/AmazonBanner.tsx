        ...
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            <h1 className="fw-bold mb-3" style={{ fontSize: '2.5rem' }}>
              Trade Amazon (AMZN) Stock
            </h1>
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Invest in Amazon, the global leader in e-commerce, cloud computing, and innovation.
            </p>
            <ul
            ...
            >
              <li>One of the world’s most valuable tech giants</li>
              <li>Track Amazon’s market movements</li>
              <li>Trade AMZN with powerful tools</li>
            </ul>
