        ...
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            <h1 className="fw-bold mb-3" style={{ fontSize: '2.5rem' }}>
              Trade Nvidia (NVDA) Stock
            </h1>
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Capitalize on AI and chip innovation with Nvidia — a market leader in graphics and computing power.
            </p>
            <ul
            ...
            >
              <li>AI boom & semiconductor dominance</li>
              <li>Massive institutional interest</li>
              <li>Trade NVDA with tight spreads</li>
            </ul>
          ...
          <div className="col-md-6 mt-4 mt-md-0 text-center">
            <img
              src="/assets/nvidia-banner.png"
              alt="Trade Nvidia Stock"
