        ...
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            <h1 className="fw-bold mb-3" style={{ fontSize: '2.5rem' }}>
              Trade Apple (AAPL) Stock
            </h1>
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Invest in Apple, one of the world’s most valuable and innovative technology companies.
            </p>
            <ul
            ...
            >
              <li>Blue-chip stock with global impact</li>
              <li>Strong fundamentals & loyal customer base</li>
              <li>Trade AAPL with real-time data</li>
            </ul>
