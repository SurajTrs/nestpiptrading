...
const QuizBanner: React.FC = () => {
  ...
  return (
    <section style={{ backgroundColor: '#0e2240', color: '#fff', padding: '5rem 0' }}>
        ...
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            ...
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Challenge yourself with our interactive quizzes and track your learning progress.
            </p>
            <ul
            ...
            >
              <li>Quizzes for every course and level</li>
              <li>Instant results with explanations</li>
              <li>Improve retention through active testing</li>
            </ul>
