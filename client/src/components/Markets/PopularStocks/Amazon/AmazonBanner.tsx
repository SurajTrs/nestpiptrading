        ...
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            <h1 className="fw-bold mb-3" style={{ fontSize: '2.5rem' }}>
              Trade Amazon (AMZN) Stock with Powerful Tools
            </h1>
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Invest in one of the world’s most valuable tech companies with real-time data and low spreads.
            </p>
            <ul
            ...
            >
              <li>0% commission on standard stock accounts</li>
              <li>Trade AMZN with lightning-fast execution</li>
              <li>Advanced tools and analysis dashboard</li>
            </ul>
