        ...
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            <h1 className="fw-bold mb-3" style={{ fontSize: '2.5rem' }}>
              Ride the AI Boom – Trade Nvidia (NVDA) Stock
            </h1>
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Tap into the growth of AI, GPUs, and data centers by trading one of the fastest-growing tech giants.
            </p>
            <ul
            ...
            >
              <li>Commission-free trading on NVDA</li>
              <li>Real-time performance analytics</li>
              <li>Trusted platform for active tech investors</li>
            </ul>
