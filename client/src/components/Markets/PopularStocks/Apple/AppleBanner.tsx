        ...
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            <h1 className="fw-bold mb-3" style={{ fontSize: '2.5rem' }}>
              Invest in Apple (AAPL) – Innovation at Your Fingertips
            </h1>
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Trade one of the world’s most iconic tech giants with advanced tools and zero commission.
            </p>
            <ul
            ...
            >
              <li>Real-time pricing on AAPL stock</li>
              <li>0% commission with standard accounts</li>
              <li>Trusted platform for fast, reliable execution</li>
            </ul>
          ...
          <div className="col-md-6 mt-4 mt-md-0 text-center">
            <img
              src="/assets/apple-banner.png"
              alt="Trade Apple Stock"
