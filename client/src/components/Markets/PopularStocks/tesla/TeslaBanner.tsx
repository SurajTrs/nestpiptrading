        ...
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            <h1 className="fw-bold mb-3" style={{ fontSize: '2.5rem' }}>
              Drive the Future – Trade Tesla (TSLA) Shares
            </h1>
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Join the electric revolution by trading one of the most innovative carmakers in the world.
            </p>
            <ul
            ...
            >
              <li>Zero commission on TSLA trades</li>
              <li>Trade the volatility of EV stocks</li>
              <li>Fast execution with advanced platforms</li>
            </ul>
