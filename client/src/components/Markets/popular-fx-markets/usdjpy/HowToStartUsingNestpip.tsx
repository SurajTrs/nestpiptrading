...
const HowToStartUsingNestpip: React.FC = () => {
  const steps = [
    'Sign up for free — no forms to fill out',
    'Check your account — fast and secure',
    'Deposit funds — start with just $10',
    'Start trading USD/JPY with live prices and no spreads',
  ];
        ...
        <Row>
          ...
          <Col md={6} className="text-center mx-auto">
            <h2 className="fw-bold mb-4" style={{ color: 'white' }}>
              How to Start Using Nestpip
            </h2>
            <p style={{ fontSize: '1.1rem', color: 'rgba(255,255,255,0.9)' }}>
              Joining the Best Forex Trading Platform and starting to trade USD/JPY only takes a few minutes.
              It’s easy, quick, and great for beginners.
            </p>
...
export default HowToStartUsingNestpip;
