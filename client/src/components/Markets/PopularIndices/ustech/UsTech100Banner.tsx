...
const UsTech100Banner: React.FC = () => {
        ...
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            <h1 className="fw-bold mb-3" style={{ fontSize: '2.5rem' }}>
              Trade US Tech 100 (NASDAQ)
            </h1>
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Tap into innovation by trading the NASDAQ 100 index — home to the world’s top tech giants.
            </p>
            <ul
            ...
            >
              <li>Includes Apple, Microsoft, Tesla & more</li>
              <li>Highly liquid and volatile</li>
              <li>Fast execution with tight spreads</li>
            </ul>
          ...
          <div className="col-md-6 mt-4 mt-md-0 text-center">
            <img
              src="/assets/nasdaq-banner.png"
              alt="Trade US Tech 100"
...
export default UsTech100Banner;
