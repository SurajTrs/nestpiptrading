...
const WallStreetBanner: React.FC = () => {
      ...
      <div className="container text-center">
        ...
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            ...
            >
              <li>Leverage up to 1:100 on indices</li>
              <li>Trade Wall Street with precision tools</li>
              <li>No commission on standard index accounts</li>
            </ul>
          ...
          <div className="col-md-6 mt-4 mt-md-0 text-center">
            <img
              src="/assets/wallstreet-banner.png"
              alt="Trade Wall Street Index"
...
export default WallStreetBanner;
