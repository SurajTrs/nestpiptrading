  ...
  return (
    <section style={{ backgroundColor: '#f24521', color: 'white', padding: '4rem 0' }}>
      ...
      <Container className="mt-5" style={{ maxWidth: '800px' }}>
        <h3 className="fw-bold mb-4" style={{ color: '#f24521', textAlign: 'center' }}>
          How to Use Nestpip Index Trading Platform
        </h3>
       
        <p style={{ fontSize: '1rem', color: '#444', marginTop: '1.5rem', textAlign: 'center' }}>
          We want our onboarding process to be quick and easy for new users. Our team is here to help you 24 hours a day, five days a week.
        </p>
      </Container>
    </section>
  );
