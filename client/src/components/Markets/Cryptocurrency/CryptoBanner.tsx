...
const MarketCategories: React.FC = () => {
  ...
  const currentMarket = pathname?.split('/').pop()?.replace(/-/g, ' ').toLowerCase();
    ...
    description:
      'Explore the dynamic world of digital assets. Trade Bitcoin, Ethereum, and altcoins 24/7 with secure platforms and advanced tools.',
    imgSrc: '/assets/crypto-banner.png', // ✅ Make sure this image exists
    imgAlt: 'Cryptocurrency trading banner',
  };
