...
const categories = ['Forex', 'Indices', 'Shares', 'Commodities', 'Metals', 'Cryptos'];

const CrptoMarketPricing = () => {
      ...
      <div className="container">
        ...
        <div className="text-center mb-4">
          {categories.map((cat, index) => (
            <span key={index} className="badge bg-dark text-white mx-1 px-3 py-2">
              {cat}
            </span>
          ))}
        </div>
...
export default CrptoMarketPricing;
