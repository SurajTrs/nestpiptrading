...
const MarketCategories: React.FC = () => {
  ...
  const heroData = {
    title: 'Trade Crude Oil CFDs with Confidence',
    description:
      'Speculate on the price movements of WTI and Brent crude oil — the world’s most traded commodities — with flexible leverage and tight spreads.',
    imgSrc: '/assets/crude-oil-banner.png', // ✅ Replace with your actual image path
    imgAlt: 'Crude oil trading banner',
  };
