...
const MarketCategories: React.FC = () => {
  ...
  const heroData = {
    title: 'Trade Gold and Silver with Confidence',
    description:
      'Explore opportunities in precious metals trading. Gold and silver offer stability in times of market volatility and are key instruments for long-term diversification.',
    imgSrc: '/assets/gold-silver-banner.png', // Replace with your actual image path
    imgAlt: 'Gold and Silver trading banner',
  };

  return (
    <section className="market-categories-page-section">
      <section style={{ backgroundColor: '#FF7A00', color: '#fff', padding: '5rem 0' }}>
