...
const TradePricesBanner: React.FC = () => {
  ...
  return (
    <section style={{ backgroundColor: '#f24521', color: '#fff', padding: '5rem 0' }}>
      <div className="container text-center">
        ...
        {/* Trade Prices Hero Content */}
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            <h1 className="fw-bold mb-3" style={{ fontSize: '2.5rem' }}>
              See What You Pay – Transparent Trade Prices
            </h1>
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              View real-time bid/ask prices and understand our pricing model before placing any trade.
            </p>
            <ul
            ...
            >
              <li>Live spreads and execution pricing</li>
              <li>No hidden markups or delays</li>
              <li>Institutional-grade data feeds</li>
            </ul>
          ...
          <div className="col-md-6 mt-4 mt-md-0 text-center">
            <img
              src="/assets/trade-prices-banner.png"
              alt="Trade Prices"
...
export default TradePricesBanner;
