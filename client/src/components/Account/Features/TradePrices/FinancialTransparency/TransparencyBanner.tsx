...
const marketNavItems = [
  { icon: '/icons/Compare-icon.svg', label: 'Compare' },
  { icon: '/icons/FinancialTransparency-icon.svg', label: 'Financial Transparency' },
];

const FinancialTransparencyBanner: React.FC = () => {
  ...
  return (
    <section style={{ backgroundColor: '#f24521', color: '#fff', padding: '5rem 0' }}>
      <div className="container text-center">
        ...
        >
          {marketNavItems.map(({ icon, label }, idx) => {
            ...
            return (
              <a
                key={idx}
                href={`/accounts/${label.toLowerCase().replace(/\s+/g, '-')}`}
        ...
        {/* Financial Transparency Hero Content */}
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            ...
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Transparent financial practices ensure trust and confidence for all our traders.
            </p>
            <ul
            ...
            >
              <li>Clear fee structures and no hidden costs</li>
              <li>Regular financial audits and reports</li>
          ...
          <div className="col-md-6 mt-4 mt-md-0 text-center">
            <img
              src="/assets/financial-transparency-banner.png"
...
export default FinancialTransparencyBanner;
