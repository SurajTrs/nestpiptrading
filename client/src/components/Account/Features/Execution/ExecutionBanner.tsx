...
const ExecutionBanner: React.FC = () => {
        ...
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            <h1 className="fw-bold mb-3" style={{ fontSize: '2.5rem' }}>
              Lightning-Fast Execution You Can Rely On
            </h1>
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Experience ultra-low latency and reliable trade execution backed by premium infrastructure.
            </p>
            <ul
            ...
            >
              <li>Average execution speed under 30ms</li>
              <li>High-capacity servers across major financial hubs</li>
              <li>No requotes, no delays — just precision</li>
            </ul>
          ...
          <div className="col-md-6 mt-4 mt-md-0 text-center">
            <img
              src="/assets/execution-banner.png"
              alt="Fast Trade Execution"
