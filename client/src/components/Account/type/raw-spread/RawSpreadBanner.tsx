...
const RawSpreadBanner: React.FC = () => {
      ...
      <div className="container text-center">
        ...
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            ...
            >
              <li>Spreads from 0.0 pips on major FX pairs</li>
              <li>Low commissions & ultra-fast execution</li>
              <li>Perfect for scalping & algorithmic trading</li>
            </ul>
          ...
          <div className="col-md-6 mt-4 mt-md-0 text-center">
            <img
              src="/assets/rawspread-banner.png"
              alt="Raw Spread Trading"
...
export default RawSpreadBanner;
