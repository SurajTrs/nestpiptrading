        ...
        <div className="row align-items-center text-md-start text-center mt-5">
          <div className="col-md-6">
            <h1 className="fw-bold mb-3" style={{ fontSize: '2.5rem' }}>
              Compare Our Trading Platforms & Choose Your Best Fit
            </h1>
            <p className="mb-4" style={{ fontSize: '1.2rem', maxWidth: '620px', margin: '0 auto' }}>
              Explore features, tools, and advantages of each platform to trade smarter and faster.
            </p>
            <ul
            ...
            >
              <li>Detailed platform comparisons</li>
              <li>Performance, tools, and user experience</li>
              <li>Choose the ideal platform for your strategy</li>
            </ul>
